...
describe Poser::Mimicker do
  describe "class methods" do
    ...
    describe "mimic" do
      ...
      it "returns the object if it's mimicked already" do
        @object.stub(:mimicked?) { true }
        subject.mimic(@object, @context).should == @object
      end

      # it "returns the result of the object presenting itself if it knows how" do
      #   result = Object.new
      #   @object.stub(:to_delegator) { result }
